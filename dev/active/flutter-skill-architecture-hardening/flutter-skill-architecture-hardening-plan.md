...
## 개요
Flutter 가이드 스킬 문서(`.gemini/skills/flutter-dev-guidelines`)의 아키텍처 정책과 완료 게이트(G1~G5)를 재검토 findings 기준으로 강화한다.
...
## 범위
- 포함:
  - `.gemini/skills/flutter-dev-guidelines/SKILL.md`
  - `.gemini/skills/flutter-dev-guidelines/resources/*.md`
