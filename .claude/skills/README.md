...
컨텍스트에 따라 자동 활성화되는, 프로덕션에서 검증된 Claude Code용 스킬 모음입니다.

---

## 스킬이란?

스킬은 필요할 때 Claude가 로드하는 모듈형 지식 베이스입니다. 스킬은 다음을 제공합니다:
- 도메인별 가이드라인
- 모범 사례
- 코드 예제
- 피해야 할 안티패턴
...
전체 안내는 [CLAUDE_INTEGRATION_GUIDE.md](../../CLAUDE_INTEGRATION_GUIDE.md)를 참고하세요.
...
**확인:**
1. 스킬 디렉터리가 `.claude/skills/`에 있나요?
...
**질문이 있나요?** 더 자세한 통합 가이드는 [CLAUDE_INTEGRATION_GUIDE.md](../../CLAUDE_INTEGRATION_GUIDE.md)를 참고하세요.
