...
# Uses stderr for visibility in Gemini CLI main interface
...
CACHE_DIR="$PROJECT_DIR/.gemini/tsc-cache/$SESSION_ID"
...
find "$PROJECT_DIR/.gemini/tsc-cache" -maxdepth 1 -type d -mtime +7 -exec rm -rf {} \; 2>/dev/null || true
