...
- **Claude Code:** [`CLAUDE_INTEGRATION_GUIDE.md`](CLAUDE_INTEGRATION_GUIDE.md)
- **Codex CLI:** [`CODEX_INTEGRATION_GUIDE.md`](CODEX_INTEGRATION_GUIDE.md)
- **Agent Workflows:** [`AGENT_WORKFLOWS_INTEGRATION_GUIDE.md`](AGENT_WORKFLOWS_INTEGRATION_GUIDE.md)
...
**👉 설정 가이드:** [`.claude/hooks/README.md`](.claude/hooks/README.md) / [`.codex/hooks/README.md`](.codex/hooks/README.md) / [`.agents/workflows/hooks/README.md`](.agents/workflows/hooks/README.md)

### 📚 스킬 하나만 추가하고 싶어요

[스킬 카탈로그](.claude/skills/)에서 필요한 것만 골라 복사하세요.  
(Codex/Gemini는 동일한 구조의 `.codex/skills/`, `.agents/workflows/skills/` 사용)
...
**👉 스킬 가이드:** [`.claude/skills/README.md`](.claude/skills/README.md) / [`.codex/skills/README.md`](.codex/skills/README.md) / [`.agents/workflows/skills/README.md`](.agents/workflows/skills/README.md)
...
**👉 에이전트 가이드:** [`.claude/agents/README.md`](.claude/agents/README.md) / [`.codex/agents/README.md`](.codex/agents/README.md) / [`.agents/workflows/agents/README.md`](.agents/workflows/agents/README.md)
...
### 사용자용
**통합이 잘 안 되나요?**
1. 사용 중인 CLI에 맞는 가이드 확인
   - Claude: [CLAUDE_INTEGRATION_GUIDE.md](CLAUDE_INTEGRATION_GUIDE.md)
   - Codex: [CODEX_INTEGRATION_GUIDE.md](CODEX_INTEGRATION_GUIDE.md)
   - Gemini: [AGENT_WORKFLOWS_INTEGRATION_GUIDE.md](AGENT_WORKFLOWS_INTEGRATION_GUIDE.md)
2. 사용 중인 CLI에게 질문: "왜 [skill]이 활성화되지 않지?"
3. 프로젝트 구조와 함께 이슈 등록

### AI CLI 에이전트용
사용자 통합 지원 시:
1. **먼저 현재 CLI에 맞는 통합 가이드 읽기**
2. 프로젝트 구조 질문
3. 무작정 복사하지 말고 맞춤 적용
4. 통합 후 검증
...
- 📖 [Claude 통합 가이드](CLAUDE_INTEGRATION_GUIDE.md)
- 📖 [Codex 통합 가이드](CODEX_INTEGRATION_GUIDE.md)
- 📖 [Agent Workflows 통합 가이드](AGENT_WORKFLOWS_INTEGRATION_GUIDE.md)
- 📖 [Agent Workflows 가이드](AGENT_WORKFLOWS.md)
- 🎨 스킬 문서: [`.claude/skills/README.md`](.claude/skills/README.md) / [`.codex/skills/README.md`](.codex/skills/README.md) / [`.agents/workflows/skills/README.md`](.agents/workflows/skills/README.md)
- 🪝 훅 설정: [`.claude/hooks/README.md`](.claude/hooks/README.md) / [`.codex/hooks/README.md`](.codex/hooks/README.md) / [`.agents/workflows/hooks/README.md`](.agents/workflows/hooks/README.md)
- 🤖 에이전트 가이드: [`.claude/agents/README.md`](.claude/agents/README.md) / [`.codex/agents/README.md`](.codex/agents/README.md) / [`.agents/workflows/agents/README.md`](.agents/workflows/agents/README.md)
