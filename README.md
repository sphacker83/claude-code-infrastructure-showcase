...
**이 문서는 https://github.com/diet103/claude-code-infrastructure-showcase 를 한국어로 번역한 것입니다.**
...
- **Gemini CLI:** [`GEMINI_INTEGRATION_GUIDE.md`](GEMINI_INTEGRATION_GUIDE.md)
...
**👉 설정 가이드:** [`.claude/hooks/README.md`](.claude/hooks/README.md) / [`.codex/hooks/README.md`](.codex/hooks/README.md) / [`.gemini/hooks/README.md`](.gemini/hooks/README.md)

### 📚 스킬 하나만 추가하고 싶어요

[스킬 카탈로그](.claude/skills/)에서 필요한 것만 골라 복사하세요.  
(Codex/Gemini는 동일한 구조의 `.codex/skills/`, `.gemini/skills/` 사용)
...
**👉 스킬 가이드:** [`.claude/skills/README.md`](.claude/skills/README.md) / [`.codex/skills/README.md`](.codex/skills/README.md) / [`.gemini/skills/README.md`](.gemini/skills/README.md)
...
**👉 에이전트 가이드:** [`.claude/agents/README.md`](.claude/agents/README.md) / [`.codex/agents/README.md`](.codex/agents/README.md) / [`.gemini/agents/README.md`](.gemini/agents/README.md)
...
1. 사용 중인 CLI에 맞는 가이드 확인
   ...
   - Gemini: [GEMINI_INTEGRATION_GUIDE.md](GEMINI_INTEGRATION_GUIDE.md)
...
- 📖 [Gemini 통합 가이드](GEMINI_INTEGRATION_GUIDE.md)
- 📖 [Gemini 운영 가이드](GEMINI.md)
- 🎨 스킬 문서: [`.claude/skills/README.md`](.claude/skills/README.md) / [`.codex/skills/README.md`](.codex/skills/README.md) / [`.gemini/skills/README.md`](.gemini/skills/README.md)
- 🪝 훅 설정: [`.claude/hooks/README.md`](.claude/hooks/README.md) / [`.codex/hooks/README.md`](.codex/hooks/README.md) / [`.gemini/hooks/README.md`](.gemini/hooks/README.md)
- 🤖 에이전트 가이드: [`.claude/agents/README.md`](.claude/agents/README.md) / [`.codex/agents/README.md`](.codex/agents/README.md) / [`.gemini/agents/README.md`](.gemini/agents/README.md)
