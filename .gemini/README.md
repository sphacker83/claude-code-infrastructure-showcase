# Gemini CLI 인프라 쇼케이스 (`.gemini`, 한국어판)
**이 문서는 https://github.com/diet103/codex-code-infrastructure-showcase 를 한국어로 번역/정리한 자료를 기반으로, Gemini CLI용 `.gemini` 구성에 맞게 재작성한 것입니다.**

**실서비스에서 검증된 “스킬 자동 활성화” 인프라를 Gemini CLI 환경에서 그대로 재사용**할 수 있도록, 훅/스킬/에이전트/명령어를 레퍼런스로 제공합니다.
...
Gemini용 단계별 통합 가이드는 [`GEMINI.md`](../GEMINI.md)를 읽으세요.
...
**배경:**
이 인프라는 원문 Reddit 글 ["Roo Codex is a Beast – Tips from 6 Months of Hardcore Use"](https://www.reddit.com/r/CodexAI/comments/1oivjvm/claude_code_is_a_beast_tips_from_6_months_of/)에서 소개된 패턴을 Gemini CLI 환경에 맞게 옮긴 것입니다.
...
- 📖 [Gemini 통합 가이드](../GEMINI.md) - Gemini CLI 설정/통합
